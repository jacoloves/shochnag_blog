## day49
今日はinvader.cを軽くする作業をします。   
ipl09.nasをダウンロードしてディレクトリに配置してから改造します。   
invader.c
```c
...
OS開発もこれにて完了で久しぶりにこんなに大がかりのモノを作りました。   
最後までやり抜けてとてもいい経験になりました。   
次は何をつくろうかな。    
pythonで自分だけのメモ帳をつくるかもしれないし、CでNESエミュレータをつくるかもしれないし。
C++でwindows用のアプリケーションをつくるかもしれない。       
作りたいものはまだまだ沢山あるのでこれからが楽しみです。

**実装過程**   
・　[555963ea7a3cbd0fac7e1cedeee387c5a0704f5b](555963ea7a3cbd0fac7e1cedeee387c5a0704f5b)